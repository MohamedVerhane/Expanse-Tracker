...
function SubmitButton() {
  ...
  return (
    <Button type="submit" className="w-full" disabled={pending}>
      {pending ? t("form.signingIn") : t("action.signIn")}
    </Button>
  );
}
      ...
      <div>
        ...
        <div className="relative">
          <FontAwesomeIcon
            ...
            className="pointer-events-none absolute inset-y-0 start-3 my-auto text-slate-400"
          />
          <Input id="password" name="password" type="password" autoComplete="current-password" required placeholder="••••••••" className="ps-9" />
        </div>
